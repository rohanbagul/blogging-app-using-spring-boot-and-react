...
public class PostServiceImpl implements PostService {
	...
	public PostResponse getAllPost(Integer pageNumber, Integer pageSize,String sortBy,String sortDir) {
		...
		postResponse.setToatalElement(pagePost.getTotalElements());
	...
	public List<PostDto> searchPosts(String keyword) {
		String sqlQuery = "from Post where (title like :key)";
		List<Post> posts= entityManager.createQuery(sqlQuery, Post.class).setParameter("key", "%" + keyword + "%")
				.getResultList();
